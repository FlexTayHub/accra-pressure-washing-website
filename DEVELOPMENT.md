...
```bash
git remote add encore encore://accra-pressure-washing-website-noqi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/accra-pressure-washing-website-noqi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/accra-pressure-washing-website-noqi/settings/integrations/github)
