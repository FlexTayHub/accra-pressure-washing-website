...
export namespace contact {
    ...
    export class ServiceClient {
         ...
         */
        public async list(params: RequestType<typeof api_contact_list_list>): Promise<ResponseType<typeof api_contact_list_list>> {
            ...
            const resp = await this.baseClient.callTypedAPI(`/contact/inquiries`, {query, method: "GET", body: undefined})
